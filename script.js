...
// if the user delete the input the color delete too! 
...
function endGame() {
    ...
    speedType.textContent = `Your speed is ${speed.toFixed(3)} wpm!`
    ...
    intervalId = setInterval(function () {
        ...
        let timePass = currentTime - startTime;
        seconds = Math.floor(timePass / 1000);
