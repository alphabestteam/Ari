...
def main():
    ...
    while hero.hp > 0.4:
        ...
        if user_choice == "1":
            ...
            hero.level_up()
            monster.attack(hero)
            print(f"The monster {monster.name_of_monster} attack you, your life: {hero.hp} ")
            ...
            print("Defend your coins - {hero.coins}")
            hero.defend(monster)
            monster.attack(hero)
            print(f"The monster {monster.name_of_monster} attack you, your life: {hero.hp} your coins - {hero.coins}")
